import enum
import random
from numba import njit, jit, jitclass, int64, float64, typeof
import numba

import games.stack_queue_impl as collections


# This klotski/Hua Rong Dao game is used for testing purpose.
...
#     ('length', int64),
#     ('width', int64),
#     ("occupied", typeof([[0,0], [0,0]])),  # this line is not working
# ]
#
#
# @jitclass(spec_sb)  # not working with hidden field occupied
class SlidingBlock:
...
# This is not working, self referencing, use SlidingGameBoard before it's defined
# spec_sg = [
#     ('length', int64),
#     ('width', int64),
#     ('sliding_blocks', numba.types.List(SlidingBlock.class_type.instance_type, reflected=True)),
#     ('finish_criteria', numba.types.FunctionType(bool(SlidingGameBoard.class_type.instance_type))),
# ]


# @jitclass(spec_sg)  # can't handle function finish_criteria
